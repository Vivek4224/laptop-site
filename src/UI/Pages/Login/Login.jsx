...
import "./Login.css";
import fb from "../../../Image/icon_fb.svg";
import google from "../../../Image/icon_google.svg";
import apple from "../../../Image/icon_apple.svg";
import micro from "../../../Image/icon_microsoft.svg";
import { Cog, Laptop, MonitorDown, Newspaper, ShoppingCart, TicketPercent } from 'lucide-react';
        ...
        <>
            <div className="login_container">
                ...
                <div className="right_container">
                    <h2 className="login" style={{ marginTop: "1rem", fontSize: "1.5rem", fontWeight: "bold" }}>Account Login</h2>
